...
class SettingsController < ApplicationController
  ...
  SETTING_CATEGORIES = {
    ...
    "is_branch_of_foreign_entity" => "entity_info",
    "parent_company_country" => "entity_info",
    "last_amsf_audit_recency" => "entity_info",
    "applies_risk_ratings_to_clients" => "kyc_procedures",
    "high_risk_purchase_sale_review_frequency" => "kyc_procedures",
    ...
    "has_written_aml_policies" => "compliance_policies",
    "last_policy_update_date" => "compliance_policies",
    "risk_assessment_performed" => "compliance_policies",
    "internal_controls" => "compliance_policies",
    "policy_preparer" => "compliance_policies",
  ...
  def settings_params
    params.expect(settings: [
      ...
      :is_branch_of_foreign_entity,
      :parent_company_country,
      :last_amsf_audit_recency,
      :applies_risk_ratings_to_clients,
      :high_risk_purchase_sale_review_frequency,
      :standard_cdd_frequency,
      :edd_for_peps,
      :edd_for_high_risk_countries,
      :edd_for_complex_structures,
      :sdd_applied,
      :has_written_aml_policies,
